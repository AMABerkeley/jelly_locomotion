...
#
    ...
    def apply_action_pos(self, action):
        ...
        for j in range (12):
            ...
            p.setJointMotorControl2(self.q, self.jointIds[j], p.POSITION_CONTROL, targetPos, force=100)
...
#
    ...
    ####################### Walking ###################################
    offset = 0.07
    p1 = np.array([offset + 1.85e-01, -0.1e-02, -3.40e-01])
    p2 = np.array([-1.85e-01, -0.1e-02, -3.40e-01])
